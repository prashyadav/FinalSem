...
public class ManagerHome extends AppCompatActivity {
  ...
  //  private ProgressDialog progressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  progressDialog = new ProgressDialog(ManagerHome.this);
        ...
        //Commented this for PPT on 25th set on clicklistneer only
  ...
  public boolean onCreateOptionsMenu(Menu menu)
  {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        //Commented below if for PPT on 25th
        if(id==R.id.id_scan)
        {
        ...
        if(id==R.id.id_Comp)
        {
            //Inten changed from AdminComplainds rto simpleAdmin
        ...
        {
            //Inten changed from FeedbackAdmin to simpleAdmin
