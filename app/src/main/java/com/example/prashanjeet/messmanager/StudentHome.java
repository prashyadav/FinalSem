...
//        });
    ...
    //Commented this setonclick for PPT on 25th
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if(id==R.id.id_Comp)
        {
            //Intent changed from Complaint to simpleAdmin
            Intent intent=new Intent(StudentHome.this,Complaint.class);
        ...
        {
            //Intent changed from Feedback to simpleAdmin
